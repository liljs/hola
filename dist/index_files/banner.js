...
_hsp.push(["addCookieDomain", ".workos.com"]);
...
!(function (e) {
          ...
          for (t = 0; t < l.length; t++) {
            ...
            if ((h = e.attributes[d])) {
              ...
              if (this.config.protocols[a] && this.config.protocols[a][d]) {
                ...
                g = (f = h.value.toLowerCase().match(s.REGEX_PROTOCOL))
                  ? -1 != n(f[1], _)
                  : -1 != n(s.RELATIVE, _);
              }
              if (g) {
  ...
  function (e, t, n) {
    ...
    const D = new R.a({
        ...
        protocols: {
          a: { href: ["http", "https", "mailto", R.a.ALL] },
          blockquote: { cite: ["http", "https", R.a.RELATIVE] },
    ...
    class Y {
      ...
      static fromJS(e) {
        return new Y(
          e.acceptAllLabel,
          e.saveSettingsLabel,
          M.fromJS(e.introduction),
          M.fromJS(e.categories.necessary),
          M.fromJS(e.categories.analytics),
          M.fromJS(e.categories.advertisement),
          M.fromJS(e.categories.functionality)
        );
      }
      getSanitizedText() {
        return new Y(
          U(this.acceptLabel),
          U(this.saveSettingsLabel),
    ...
    class F {
      ...
      static fromJS(e) {
        return new F(
          ...
          e.modalText && Y.fromJS(e.modalText)
        );
      }
      getSanitizedText() {
        return new F(
          ...
          U(this.declineLabel),
          U(this.disclaimer),
          this.cookieSettingsLabel && U(this.cookieSettingsLabel),
    ...
    const K = 1,
      W = 2,
      q = 3,
      j = { [K]: "analytics", [W]: "advertisement", [q]: "functionality" };
    class J {
      constructor(e, t, n) {
        this.allowed = e;
    ...
    function fe(e, t, n) {
      ...
      if (
        (arguments.length > 2 &&
          (r.children = arguments.length > 3 ? oe.call(arguments, 2) : n),
    ...
    function ve(e) {
      ((!e.__d && (e.__d = !0) && re.push(e) && !Ce.__r++) ||
        ce !== ie.debounceRendering) &&
        ((ce = ie.debounceRendering) || ae)(Ce);
    }
    function Ce() {
      for (var e; (Ce.__r = re.length); )
        (e = re.sort(function (e, t) {
      ...
      for (n.__k = [], h = 0; h < t.length; h++)
        if (
          ...
          (_ = n.__k[h] =
            null == (_ = t[h]) || "boolean" == typeof _
              ...
              : "string" == typeof _ ||
                "number" == typeof _ ||
                "bigint" == typeof _
              ? ge(null, _, null, null, _)
              : Array.isArray(_)
              ? ge(me, { children: _ }, null, null, null)
              : _.__b > 0
              ? ge(_.type, _.props, _.key, null, _.__v)
              : _)
        ) {
          if (
            ((_.__ = n),
            (_.__b = n.__b + 1),
            null === (u = p[h]) || (u && _.key == u.key && _.type === u.type))
          )
            p[h] = void 0;
          else
            for (d = 0; d < b; d++) {
          ...
          Le(e, _, (u = u || le), i, s, r, a, c, l),
            ...
            null != f
              ? (null == g && (g = f),
                "function" == typeof _.type && _.__k === u.__k
                  ? (_.__d = c = Se(_, c, e))
                  : (c = we(e, _, u, p, f, c)),
                "function" == typeof n.type && (n.__d = c))
              : c && u.__e == c && c.parentNode != e && (c = be(u));
        }
      for (n.__e = g, h = b; h--; )
        null != p[h] &&
          ("function" == typeof n.type &&
            ...
            (n.__d = be(o, h + 1)),
          Pe(p[h], p[h]));
      if (m) for (h = 0; h < m.length; h++) Be(m[h], m[++h], m[++h]);
    }
    function Se(e, t, n) {
    ...
    function Te(e, t, n, o, i) {
      var s;
      for (s in n)
        "children" === s || "key" === s || s in t || Oe(e, s, null, n[s], o);
      for (s in t)
    ...
    function ke(e, t, n) {
      "-" === t[0]
        ? e.setProperty(t, n)
        : (e[t] =
            null == n ? "" : "number" != typeof n || de.test(t) ? n : n + "px");
    }
    function Oe(e, t, n, o, i) {
      ...
      e: if ("style" === t)
        if ("string" == typeof n) e.style.cssText = n;
          ...
          if (n) for (t in n) (o && n[t] === o[t]) || ke(e.style, t, n[t]);
        }
      else if ("o" === t[0] && "n" === t[1])
        (s = t !== (t = t.replace(/Capture$/, ""))),
          ...
          (e.l[t + s] = n),
          n
            ? o || e.addEventListener(t, s ? Ie : Ee, s)
            : e.removeEventListener(t, s ? Ie : Ee, s);
        ...
        e: if ("function" == typeof v) {
          if (
            ...
            null != v.getDerivedStateFromProps &&
              (h.__s == h.state && (h.__s = ue({}, h.__s)),
              ue(h.__s, v.getDerivedStateFromProps(m, h.__s))),
            (u = h.props),
            (_ = h.state),
            d)
          )
          ...
          (h.context = b),
            ...
            null != h.getChildContext &&
              (o = ue(ue({}, o), h.getChildContext())),
            d ||
              null == h.getSnapshotBeforeUpdate ||
              (f = h.getSnapshotBeforeUpdate(u, _)),
            (y =
              null != l && l.type === me && null == l.key
                ? l.props.children
                : l),
            xe(e, Array.isArray(y) ? y : [y], t, n, o, i, s, r, a, c),
            (h.base = t.__e),
            (t.__h = null),
            h.__h.length && r.push(h),
            g && (h.__E = h.__ = null),
    ...
    function Ae(e, t, n, o, i, s, r, a) {
      ...
      if (null === _) d === u || (a && e.data === u) || (e.data = u);
        ...
        if (
          ((s = s && oe.call(e.childNodes)),
          (l = (d = n.props || le).dangerouslySetInnerHTML),
        ...
        a ||
          ("value" in u &&
            ...
            (f !== e.value ||
              ("progress" === _ && !f) ||
              ("option" === _ && f !== d.value)) &&
            Oe(e, "value", f, d.value, !1),
          "checked" in u &&
            void 0 !== (f = u.checked) &&
            f !== e.checked &&
            Oe(e, "checked", f, d.checked, !1));
      }
      return e;
    }
    function Be(e, t, n) {
    ...
    function Pe(e, t, n) {
      ...
      if (
        ...
        (o = e.ref) && ((o.current && o.current !== e.__e) || Be(o, null, t)),
        null != (o = e.__c))
      ) {
      ...
      if ((o = e.__k))
        for (i = 0; i < o.length; i++)
          o[i] && Pe(o[i], t, "function" != typeof e.type);
    ...
    (ie.__b = function (e) {
      ...
      (ie.diffed = function (e) {
        ...
        t &&
          t.__H &&
          t.__H.__h.length &&
          ((1 !== ze.push(t) && Fe === ie.requestAnimationFrame) ||
            (
              (Fe = ie.requestAnimationFrame) ||
              function (e) {
                var t,
                  n = function () {
                    clearTimeout(o),
    ...
    function lt({
      ...
      const _ = r ? -1 : 0,
        ...
        p =
          g === H.OPT_IN ||
          g === H.OPT_OUT ||
          g === H.OPT_OUT_BY_CATEGORY ||
          g === H.COOKIES_BY_CATEGORY;
      return Ge("div", {
        id: u,
        className:
          i.customizationSettings.position === A.BOTTOM
    ...
    function ht({
      ...
      return Ge("div", {
        ...
        children: [
          Ge("div", { className: "hs-toggle-switch-nob" }),
          Ge("label", {
            htmlFor: i,
            children: Ge("span", {
              className: "hs-hidden",
            ...
            children: [
              Ge("button", {
                ...
                children: [
                  ...
                  Ge("span", { dangerouslySetInnerHTML: G(n.label) }),
                ],
              }),
              !a &&
                Ge(ht, {
    ...
    function Ct({
      ...
      const [h, d] = Je(t.categories.analytics),
        [u, _] = Je(t.categories.advertisement),
        [f, b] = Je(t.categories.functionality),
        y = () => {
          i({ [p.ANALYTICS]: h, [p.ADVERTISEMENT]: u, [p.FUNCTIONALITY]: f });
        },
        v = () => {
          d(!0);
          _(!0);
    ...
    function St({ apiBaseUrl: e, context: t, setting: n, onCloseBanner: o }) {
    ...
    function kt(e, t, n, o, i) {
      const s = wt(t, o);
      De(
        Ge(St, { apiBaseUrl: e, context: t, setting: n, onCloseBanner: i }),
        s
      );
      return s;
    }
    class Ot {
      static postActivity(e, t, n) {
        fetch(e, {
          ...
          .then(() => O.info(`Sent a banner ${t} event.`))
          .catch(() =>
            O.error(`There was an issue sending a banner ${t} event.`)
          );
      }
      static sendView(e, t) {
    ...
    const It = { [Et.ROUND]: "0.5em", [Et.SQUARE]: "0", [Et.PILL]: "3em" },
      Lt = { [Et.ROUND]: "12px", [Et.SQUARE]: "0", [Et.PILL]: "0" },
      Nt = (e) => null == e,
      At = (e, t) => (t ? [{ cssVar: e, value: t }] : []),
      Bt = (e, t) => (t ? [{ cssVar: e, value: `${t.number}${t.units}` }] : []),
      Pt = (e, t) => (Nt(t) ? [] : [{ cssVar: e, value: It[t] }]),
      Rt = (e, t) => (Nt(t) ? [] : [{ cssVar: e, value: Lt[t] }]),
      Dt = (e, t) =>
        Nt(t)
          ? []
          : [
              ...At(`--hs-banner-${e}-color`, t.color),
              ...At(`--hs-banner-${e}-text-color`, t.textColor),
              ...At(`--hs-banner-${e}-border-color`, t.borderColor),
            ],
      Ut = (e) =>
        Nt(e)
          ? []
      ...
      Yt = (e) => [
        ...At("--hs-banner-color", e.bannerColor),
        ...At("--hs-banner-text-color", e.bannerTextColor),
        ...At(
          "--hs-banner-settings-text-color",
          e.bannerSettingsButtonTextColor
        ),
        ...Bt("--hs-banner-width", e.bannerWidth),
        ...Bt("--hs-banner-padding", e.bannerPadding),
        ...Rt("--hs-banner-corners", e.bannerCorners),
        ...Pt("--hs-banner-button-corners", e.bannerButtonCorners),
        ...Dt("accept", e.bannerAcceptButtonStyle),
        ...Dt("decline", e.bannerDeclineButtonStyle),
        ...Ut(e.showCloseButton),
        ...Gt(e.position),
        ...At("--hs-banner-modal-color", e.modalColor),
        ...At("--hs-banner-modal-text-color", e.modalTextColor),
        ...Bt("--hs-banner-modal-padding", e.modalContainerPadding),
        ...Bt("--hs-banner-modal-width", e.modalWidth),
        ...Rt("--hs-banner-modal-corners", e.modalCorners),
        ...Pt("--hs-banner-modal-button-corners", e.modalButtonCorners),
        ...Dt("modal-accept", e.modalAcceptButtonStyle),
        ...Dt("modal-save", e.modalSaveSettingsButtonStyle),
        ...Rt("--hs-banner-modal-category-corners", e.modalCategoryCorners),
        ...At("--hs-banner-modal-cateogry-color", e.modalCategoryColor),
        ...At(
      ...
      Ft = (e) => [
        ...At("--hs-banner-accentColor", e.accentColor),
        ...Gt(e.position.getValue()),
        ...Ut(e.showCloseButton),
      ],
      Ht = (e) => {
        const t = {};
    ...
    class zt {
      ...
      removeDeprecatedBannerCookies() {
        this.cookie.get(ne.OPT_OUT_COOKIE.getName()) &&
          this.cookie.remove(ne.OPT_OUT_COOKIE.getName());
        this.cookie.get(ne.INITIAL_OPT_IN.getName()) &&
          this.cookie.remove(ne.INITIAL_OPT_IN.getName());
      }
      run() {
        ...
        if (!this.matchedSetting) {
          ...
          this.setConsent(new J(!0), { reportClick: !1 });
          return !1;
        }
        ...
        switch (this.matchedSetting.policy.type) {
          ...
          case H.OPT_OUT:
            if (this.useConsentFromExistingCookie()) break;
            this.setConsent(new J(!0), { persist: !1, reportClick: !1 });
            this.renderBanner();
            break;
          case H.NOTIFY:
            this.setConsent(new J(!0), { persist: !1, reportClick: !1 });
      ...
      shouldScanningOverride() {
        return (
          [
            H.OPT_OUT,
            H.OPT_OUT_BY_CATEGORY,
            H.COOKIES_BY_CATEGORY,
            H.OPT_IN,
            H.NOTIFY,
      ...
      findMatchingSetting() {
        const e = this.context.getPathname(),
          { countryCode: t, regionCode: n } = Ht(this.geoLocation),
      ...
      setApiBaseUrl(e) {
        /^https:\/\/js-?.{0,3}\.hs-banner(qa)?\.com.*/.test(e)
          ? (this.apiBaseUrl = e)
          : O.error("unsupported base Api url provided.");
      }
      setBannerSettings(e) {
        (e[this.context.getLocation().hostname] || []).forEach((e) =>
          this.bannerSettings.push($.fromJS(e))
        );
      }
      ...
      setConsentCookie() {
        ...
        e !== H.NO_COOKIES &&
          e !== H.COOKIES_WITHOUT_BANNER &&
          e !== H.NOTIFY &&
          this.cookie.set(
            ne.CATEGORY_PREFERENCE_COOKIE.getName(),
      ...
      showBanner() {
        if (
          this.matchedSetting.policy.type === H.NO_COOKIES ||
          this.matchedSetting.policy.type === H.COOKIES_WITHOUT_BANNER
        )
          return;
        this.bannerParentElement ||
      ...
      revokeCookieConsent() {
        [
          ne.INITIAL_OPT_IN.getName(),
          ne.OPT_OUT_COOKIE.getName(),
          ne.CATEGORY_PREFERENCE_COOKIE.getName(),
          ne.GPC_BANNER_DISMISS_COOKIE.getName(),
          ne.NOTIFY_BANNER_DIMISS_COOKIE.getName(),
          "__hssc",
          "__hssrc",
          "__hstc",
          "__hs_do_not_track",
    ...
    const Kt = (e) =>
      ...
      tn = (e) => {
        const t = e instanceof Error,
          ...
          o = Wt() || "prod",
          i = qt() || "na1",
          s = Xt(n, o, i, { isInstanceOfError: t });
        en(
          `${Zt(i, o)}/cookie-banner-v2/raw/error.gif?url=${
            s.request.url
    ...
    "loading" === an.readyState
      ? an.addEventListener("DOMContentLoaded", cn)
      : rn();
  },
]);
