!(function () {
  ...
  var ht = { set: F, get: O, has: x, enforce: st, getterFor: at },
    pt =
      (ht.set,
      ht.get,
      ht.has,
  ...
  var de = Et.f,
    ...
    Ve = function (t) {
      ...
      return (
        !(this === Pe && X(Ne, t) && !X(Ie, t)) &&
        (!(e || !X(this, t) || !X(Ne, t) || (X(this, ge) && this[ge][t])) || e)
      );
    },
    ze = function (t, e) {
      t = W(t);
    ...
    He = function (t) {
      for (
        var e, r = t === Pe, n = Te(r ? Ie : W(t)), i = [], o = 0;
        n.length > o;
  ...
  if (!k) {
    pt(
      (Ae = function () {
        ...
        h && _e && Ue(Pe, e, { configurable: !0, set: r });
        return Me(e, t);
      })[xe],
      "toString",
      function () {
    ...
    if (h) {
      ...
      L || pt(Pe, "propertyIsEnumerable", Ve, { unsafe: !0 });
    }
    Kt.f = function (t) {
      return Me(M(t), t);
    };
  }
  kt({ global: !0, wrap: !0, forced: !k, sham: !k }, { Symbol: Ae });
  ...
  if (
    ...
    kt({ global: !0, forced: !0 }, { Symbol: Ke });
  }
  ee("hasInstance");
  ...
  nhqU: function (t, e, r) {
        ...
        return Object.assign(
          {
            ...
            formValues: (this.get(_t.FIELDS) || []).reduce(
              (t, e) => Object.assign({}, t, { [e.label]: e.value }),
              {}
            ),
            labelToNameMap: (this.get(_t.FIELDS) || []).reduce(
    ...
    class Ht {
      constructor({ isQa: t = !1, hublet: e = "" } = {}) {
        ...
        this.submitter = new Qt({ isQa: t, hublet: e });
      }
    ...
    const Oe = ({ isEmbedApp: t = !1, env: e = "PROD", hublet: r = "" }) => {
      const n = "PROD" !== e;
      return t ? Ee({ isQa: n, hublet: r }) : we({ isQa: n, hublet: r });
    };
    class xe {
      constructor(t, e) {
        e = e || {};
    ...
    function Be(t) {
      return t.className
        ? t.className.indexOf(Ue) > -1
          ? ("." + t.className)
              .split(" ")
              .filter((t) => t.length)
              .filter((t) => -1 === Me.indexOf(t))
              .join(", .")
    ...
    function Je({ name: t, value: e, id: r, type: n, parentNode: i }) {
      return We(t)
    ...
    function rr(t, e) {
      ...
      if (r.length) return r;
      const n =
        e.getAttribute("placeholder") && er(e.getAttribute("placeholder"));
      if (n) return n;
      r = er(Ge(t, e));
      if (r.length) return r;
    ...
    function ar({ type: t, value: e, checked: r }) {
      return "checkbox" === t
        ? r
          ? "Checked"
          : "Not Checked"
    ...
    class xr {
      ...
      isSecurityCode() {
        if (
          this.getLowerCased(Sr.LABEL).indexOf(Ar) > -1 &&
          /^\d{3,4}$/.test(this.get(Sr.VALUE))
        ) {
          p(
      ...
      isUnWanted() {
        return (
          this.usesPasswordKeyword(this.getLowerCased(Sr.LABEL)) ||
          this.usesPasswordKeyword(this.getLowerCased(Sr.NAME)) ||
          Or.indexOf(this.getLowerCased(Sr.NAME)) > -1
        );
      }
      isSensitive() {
        return (
    ...
    class Mr {
      ...
      isLabeledField(t) {
        return (
          t.getLowerCased(Sr.LABEL) === Ur ||
          _r.filter((e) => t.getLowerCased(Sr.LABEL).indexOf(e) > -1).length > 0
        );
      }
      extractFirstEmail(t) {
    ...
    class zr {
      ...
      isContainingLabeledField(t) {
        return (
          $r.filter((e) => t.getLowerCased(Sr.LABEL).indexOf(e) > -1).length > 0
        );
      }
      ...
      findBest(t) {
        return (
          gr(t, this.isMarkedField) ||
          gr(t, this.isContainingLabeledField) ||
          gr(t, this.isMatchingLabeledField) ||
          gr(t, this.isNamedField) ||
          void 0
        );
      }
    }
    ...
    class Xr {
      ...
      isContainingLabeledField(t) {
        return (
          Gr.filter((e) => t.getLowerCased(Sr.LABEL).indexOf(e) > -1).length > 0
        );
      }
      isMatchingLabeledField(t) {
    ...
    class nn {
      ...
      isContainingLabeledField(t) {
        return (
          en.filter((e) => t.getLowerCased(Sr.LABEL).indexOf(e) > -1).length > 0
        );
      }
      isNamedField(t) {
      ...
      findBest(t) {
        ...
        return (
          gr(t, this.isMarkeField) ||
          gr(e, this.isTelTypeField) ||
          gr(e, this.isContainingLabeledField) ||
          gr(e, this.isNamedField) ||
          void 0
        );
      }
    }
    ...
    const sn = /[dmy]+[-\s/.]?[dm]+[-\s/.]?[dmy]+/i,
      ...
      ln = { INPUT_TYPE_DATE: "date", INPUT_TYPE_DATETIME: "datetime-local" };
    class fn {
      isBuiltInDateInputField(t) {
        return (
          t.get(Sr.TYPE) === ln.INPUT_TYPE_DATE ||
          t.get(Sr.TYPE) === ln.INPUT_TYPE_DATETIME
        );
      }
      ...
      indicatesADateFormatInPlaceholder(t) {
        return (
          !!t.get(Sr.ATTRIBUTES) &&
          sn.test(t.get(Sr.ATTRIBUTES).placeholder || "")
        );
      }
      ...
      getCustomDateInputFieldFormat(t) {
        return this.indicatesADateFormatInPlaceholder(t)
          ? this.extractFormat(t.get(Sr.ATTRIBUTES).placeholder)
          : this.extractFormat(t.get(Sr.LABEL));
      }
      hasEmptyValue(t) {
    ...
    class hn {
      ...
      rejectIfAnyFieldSensitive(t) {
        const { submissionFields: e } = t,
          r = gr(e, (t) => t.isSensitive());
        return r
          ? Promise.reject(
              new Tt(`Found sensitive submission field [${r.get(Sr.LABEL)}]`)
            )
          : t;
      }
      createSubmissionContactFieldsFromSubmissionFields(t) {
        ...
        return Object.assign({}, t, {
          submissionContactFields: r
            .setEmailField(Br.findBest(e))
            .setFirstNameField(Qr.findBest(e))
            .setLastNameField(Yr.findBest(e))
            .setPhoneNumberField(on.findBest(e)),
        });
      }
      ...
      standardiseDateValuesFromSubmissionFields(t) {
        ...
        return Object.assign({}, t, {
          submissionFields: e.map((t) =>
            !dn.hasEmptyValue(t) && dn.isDateInputField(t)
              ? new xr(
                  Object.assign({}, t, {
      ...
      createSubmissionFromState(t) {
        ...
        return Object.assign({}, t, {
          submission: r
            .set(_t.FORM_SELECTOR_ID, e.id)
            .set(_t.FORM_SELECTOR_CLASSES, e.classes)
            .set(_t.FORM_ATTRIBUTES, e.attributes)
            .set(_t.CONTACT_FIELDS, i)
            .set(_t.FIELDS, n)
            .set(_t.PAGE_ID, (window.hsVars || {}).page_id)
            .set(_t.PAGE_TITLE, document.title)
            .set(_t.PAGE_URL, window.location.href)
            .set(_t.PORTAL_ID, V())
            .set(_t.TYPE, "SCRAPED")
            .set(_t.UTK, ot())
            .set(_t.UUID, Ne())
    ...
    class mn {
      getState(t) {
        return Promise.resolve({ formEl: t });
      }
      scrapeForm(t) {
        const { formEl: e } = t;
        return Object.assign({}, t, { formData: pr.scrape(e) });
      }
      buildSubmission(t) {
        const { formData: e } = t;
        return pn.build(e).then((e) => Object.assign({}, t, { submission: e }));
      }
      buildSubmissionFromForm(t) {
        p("Submission event on: ", t);
        return this.getState(t)
          .then(this.scrapeForm)
          .then(Ie(({ formData: t }) => p("Scraped form: ", t)))
          .then(this.buildSubmission)
          .then(Ie(({ submission: t }) => p("Built submission: ", t)))
          .then(({ submission: t }) => t);
      }
    }
    var bn = new mn();
    ...
    var En = {
      ...
      setupErrorReporting(t) {
        const { utk: e, portalId: r, isQa: n, hublet: i } = t,
          o = W(),
          s = new Le(Sn, o, { utk: e, portalId: r, isQa: n, hublet: i });
      ...
      handleErrors(t) {
        ...
        if (t instanceof Tt) g(t);
          ...
          b(t);
          wn.errorReporter.report(t, { errorSource: "embed", errorKey: t.key });
        } else if (wt(t)) {
          v("An error is preventing collected-forms from executing.");
          wn.errorReporter.report(t, { errorSource: "embed" }, "report", {
            silent: !0,
          });
        } else {
          y(t);
          wn.errorReporter.debug(t, { errorSource: "client" });
        }
        return t;
      },
      attatchInstance: (t) => Object.assign({}, t, { instance: () => wn }),
      logState(t) {
        p(W() + " initialized: ", t);
        return t;
      },
