!(function () {
  var t,
    ...
    i = {
      ...
      584: function (t, e, n) {
        ...
        try {
          window.analyticsWriteKey = "Q4w3PbOUPoFT3oP4f7KDO2oym7zKCcfv";
        } catch (t) {}
        function r() {
            ...
            return (
              ...
              (t.prototype.flush = function () {
                var t = this.metrics.map(function (t) {
                  return (0,
                  r.pi)((0, r.pi)({}, t), { tags: t.tags.join(",") });
                });
                console.table ? console.table(t) : console.log(t),
                  (this.metrics = []);
              }),
  ...
  !(function () {
    ...
    var l = function (t) {
      return function () {
        for (var e, n, r, i = [], s = 0; s < arguments.length; s++)
          i[s] = arguments[s];
        for (
          var u = {}, a = ["callback", "options", "traits", "id"], c = 0, l = i;
          c < l.length;
          c++
        ) {
          var f = l[c],
        ...
        return (
          ...
          (e.prototype.page = function (e, n, r, i, o, s) {
            ...
            return (
              null !== e &&
                ((a.category = e),
                (a.properties =
                  null !== (u = a.properties) && void 0 !== u ? u : {}),
          ...
          (e.prototype.alias = function (e, n, r, i, o) {
            ...
            return (
              ...
              void 0 === e
                ...
                : this.normalize(
                    (0, t.pi)((0, t.pi)({}, this.baseEvent()), s),
                    o
                  )
            );
          }),
          ...
          (e.prototype.context = function (t) {
            ...
            return (
              s.forEach(function (t) {
                "context" !== t &&
                  (i.includes(t) ? (0, g.N)(a, t, o[t]) : (0, g.N)(u, t, o[t]));
              }),
              [u, a]
            );
          }),
          (e.prototype.normalize = function (e, n) {
            ...
            (null === (r = e.options) || void 0 === r
              ? void 0
              : r.anonymousId) && this.user.anonymousId(e.options.anonymousId);
            var s = Object.keys(
                null !== (i = e.integrations) && void 0 !== i ? i : {}
              ).reduce(function (n, r) {
                var i, o;
                return (0,
              ...
              p = (0, t.pi)(
                ...
                {
                  messageId:
                    "ajs-next-" + w().hash(JSON.stringify(e) + (0, m.v4)()),
                }
              );
            return j(p, n), p;
          }),
      ...
      E = (function (e) {
        ...
        return (
          ...
          (n.prototype.enqueuRetry = function (t, e) {
            return (
              !(t instanceof A.Y && !t.retry) && this.queue.pushWithBackoff(e)
            );
          }),
    ...
    var Z = {
          ...
          (this.options = {}),
            ...
            (this.anonymousId = function (t) {
              ...
              return null === t
                ...
                : (u.identityStore.set(u.anonKey, null != t ? t : (0, m.v4)()),
                  u.identityStore.getAndSync(u.anonKey));
            }),
            ...
            (this.options = (0, t.pi)((0, t.pi)({}, Z), e)),
        ...
        return (0, t.mG)(void 0, void 0, void 0, function () {
          ...
          return (0, t.Jh)(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                return r < i.length
                  ? ((o = i[r]), [4, at(e, o).catch(console.error)])
                  : [3, 4];
              case 2:
                t.sent(), (t.label = 3);
              case 3:
      ...
      ot = function (t) {
        return (function (t) {
          ...
          for (var e in t) if (!x.includes(e)) return !1;
          return !0;
        })(t[t.length - 1]);
      },
      st = function (t, e, n, r) {
          ...
          (e.prototype.push = function () {
            ...
            n.forEach(function (n) {
              [
                ...
                !ot(n.args) &&
                (n.args = (0, t.ev)((0, t.ev)([], n.args, !0), [P()], !1)),
                e.calls[n.method]
          ...
          (t.prototype._createChainableMethod = function (t) {
            ...
            return function () {
              ...
              return e.instance
                ...
                : (e._preInitBuffer.push(new st(t, r)), e);
            };
          }),
          t
        );
    ...
    var ht,
      vt = (function (e) {
        function n(n, r, i, o, s) {
          ...
          (l.settings = n),
            (l.settings.timeout =
              null !== (a = l.settings.timeout) && void 0 !== a ? a : 300),
            (l.queue =
              null != i
                ? i
                : (function (t, e, n) {
          ...
          return (
            ...
            (l.integrations =
              null !== (c = null == r ? void 0 : r.integrations) && void 0 !== c
                ? c
                : {}),
            (l.options = null != r ? r : {}),
            D(l),
        ...
        return (
          ...
          (n.prototype.createStore = function (t, e, n) {
            return t
              ? new J([new N()])
              : e && G(e)
              ? new J(K(W(e.stores, n)))
              : new J(
                  K([C.LocalStorage, { name: C.Cookie, settings: n }, C.Memory])
                );
          }),
            ...
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                return (
                  ...
                  [
                    2,
                    this._dispatch(l, a).then(function (t) {
                      return (
                        f.emit(
                          "page",
                          i,
    ...
    function wt() {
      ...
      return (
        (ht = { expires: 31536e6, secure: !1, path: "/" }),
        t && (ht.domain = t),
        ht
      );
    }
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      ...
                      [
                        4,
                        bt(this.instance.options.highEntropyValuesClientHints),
                      ]
                    );
                  case 2:
            ...
            void 0 === s.locale && void 0 !== c && (s.locale = c),
              (null !== (i = s.library) && void 0 !== i) ||
                (s.library = {
                  name: "analytics.js",
                  version: ""
                    .concat("web" === (0, n.B)() ? "next" : "npm:next", "-")
                    .concat(Q.i),
                }),
              a &&
                !s.campaign &&
              ...
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return [
                      4,
                      (0, Pt.applyDestinationMiddleware)(
                        this.name,
                        e.event,
                        this.middleware
                      ),
    ...
    function Et(e, n) {
      var r,
        ...
        p =
          null !== (o = null == n ? void 0 : n.timeout) && void 0 !== o
            ? o
            : 5e3;
      function d(n) {
        var r;
    ...
    function Ft(e, n, r, i) {
      ...
      for (
        var p = 0, d = (null == r ? void 0 : r.unbundledIntegrations) || [];
        p < d.length;
        p++
      ) {
        var h = d[p];
    ...
    function Nt(e, n, r) {
      ...
      var a,
        c =
          null !== (o = null == n ? void 0 : n.apiKey) && void 0 !== o ? o : "",
        l = e.options.disableClientPersistence
          ? new k.Z(e.queue.queue.maxAttempts, [])
          : new O.$(
              e.queue.queue.maxAttempts,
              "".concat(c, ":dest-Segment.io")
            ),
        f = new Set(),
        d = !1,
        h =
          null !== (s = null == n ? void 0 : n.apiHost) && void 0 !== s
            ? s
            : Jt.U,
        v =
          null !== (u = null == n ? void 0 : n.protocol) && void 0 !== u
            ? u
            : "https",
        y = "".concat(v, "://").concat(h),
      ...
      function b(i) {
        return (0, t.mG)(this, void 0, Promise, function () {
          ...
          return (0, t.Jh)(this, function (t) {
            return (0, p.s)()
              ? (l.push(i), Tt(d, l, w, Tt), [2, i])
              : (f.add(i),
                (o = i.event.type.charAt(0)),
                (s = (0, At.D)(i.event).json()),
                ...
                [
                  2,
                  g
                    .dispatch("".concat(y, "/").concat(o), Ft(e, s, n, r))
                    .then(function () {
                      return i;
                    })
                    .catch(function () {
    ...
    function Wt(t) {
      ...
      if ("alias" !== n.type && !(0, o.PO)(r))
        throw new Gt(".properties", "is not an object");
      return Ut(n), t;
    }
    var Zt,
      Vt,
      ...
      Yt =
        null !== (Zt = (Vt = (0, $.R)()).__SEGMENT_INSPECTOR__) && void 0 !== Zt
          ? Zt
          : (Vt.__SEGMENT_INSPECTOR__ = {}),
      Qt = s(6218);
    function $t(e, n) {
      return (0, t.mG)(this, void 0, Promise, function () {
        return (0, t.Jh)(this, function (t) {
            ...
            switch (k.label) {
              ...
              case 3:
                return (
                  ...
                  (A = n),
                  ("test" !== r().NODE_ENV &&
                    Object.keys(A.integrations).length > 1) ||
                  c.length > 0
                    ? [
                        4,
                        s
              ...
              case 11:
                return (
                  ...
                  [
                    4,
                    kt(n, i.integrations, _, u.obfuscate, v, h).catch(
                      function () {
                        return [];
                      }
                    ),
              ...
              case 12:
                return (
                  ...
                  (o.integrations && !1 === o.integrations["Segment.io"])
                    ? [3, 14]
                    : ((j = (P = S).push),
                      [4, Nt(i, _["Segment.io"], n.integrations)])
                );
              case 13:
              ...
              case 15:
                return (
                  (I = k.sent()),
                  Object.entries(
                    null !== (p = n.enabledMiddleware) && void 0 !== p ? p : {}
                  ).some(function (t) {
                    return t[1];
                  })
                    ? [
    ...
    function te(n, r, o) {
      ...
      return (
        void 0 === r && (r = {}),
        (0, t.mG)(this, void 0, Promise, function () {
          var h, v, y, m, g, b, w, _, x, S, P;
          return (0, t.Jh)(this, function (j) {
            switch (j.label) {
              case 0:
                return !0 === r.disable
                  ? [2, [new yt(), d._.system()]]
                  : (r.globalAnalyticsKey && (0, X.jV)(r.globalAnalyticsKey),
              ...
              case 1:
                return [
                  ...
                  (O = n.cdnURL),
                  (k = null != O ? O : (0, e.Vl)()),
                  (0, i.h)("".concat(k, "/v1/projects/").concat(I, "/settings"))
                    .then(function (t) {
                      return t.ok
                        ? t.json()
              ...
              case 3:
                return (
                  (h = v),
                  r.updateCDNSettings && (h = r.updateCDNSettings(h)),
                  "function" != typeof r.disable ? [3, 5] : [4, r.disable(h)]
                );
              case 4:
                if (j.sent()) return [2, [new yt(), d._.system()]];
                j.label = 5;
              case 5:
                return (
                  (y =
                    null ===
                      (a =
                        null === (u = h.integrations["Segment.io"]) ||
                        void 0 === u
                          ? void 0
                          : u.retryQueue) ||
                    void 0 === a ||
                    a),
                  (m = (0, t.pi)({ retryQueue: y }, r)),
                  (function (t) {
                    var e;
                    null === (e = Yt.attach) || void 0 === e || e.call(Yt, t);
                  })((g = new vt(n, m))),
                  (b = null !== (c = n.plugins) && void 0 !== c ? c : []),
                  (w =
                    null !== (l = n.classicIntegrations) && void 0 !== l
                      ? l
                      : []),
                  Qt.j.initRemoteMetrics(h.metrics),
                  (function (t, e) {
                    rt(t, e), nt(t, e);
                  })(g, o),
                  [4, Xt(n.writeKey, h, g, m, r, b, w)]
                );
              case 6:
                return (
                  (_ = j.sent()),
                  (x =
                    null !== (f = window.location.search) && void 0 !== f
                      ? f
                      : ""),
                  (S =
                    null !== (p = window.location.hash) && void 0 !== p
                      ? p
                      : ""),
                  (P = x.length ? x : S.replace(/(?=#).*(?=\?)/, "")).includes(
                    "ajs_"
                  )
                    ? [4, g.queryString(P).catch(console.error)]
                    : [3, 8]
                );
              case 7:
                j.sent(), (j.label = 8);
            ...
            case 0:
              return (
                ...
                (i =
                  null !==
                    (n =
                      null === (e = (0, X.wI)()) || void 0 === e
                        ? void 0
                        : e._loadOptions) && void 0 !== n
                    ? n
                    : {}),
                r
                  ? ((o = X.ql), [4, ee.standalone(r, i)])
                  : (console.error(
    ...
    var se = !1,
      ue = function (e) {
        new ie.B().increment(
          ...
          (0, t.ev)((0, t.ev)([], e, !0), ["wk:".concat((0, ne.M)())], !1)
        );
      };
    function ae(e) {
      return (0, t.mG)(this, void 0, void 0, function () {
