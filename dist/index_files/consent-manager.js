          ...
          var d = (function e(t, r, c, u, p) {
                  ...
                  case 59:
                    if (
                      ...
                      switch (
                        ...
                        0 < R &&
                          void 0 !==
                            (w = s(1, H, r, t, S, E, Y.length, u, p, u)) &&
                          0 === (L = (H = w.trim()).length) &&
                          (H = "\0\0"),
                        (d = H.charCodeAt(0)),
                        (h = H.charCodeAt(1)),
            ...
            if (0 < (L = Y.length)) {
              if (
                ((b = r),
                0 < R &&
                  void 0 !== (w = s(2, Y, b, t, S, E, L, u, p, u)) &&
                  0 === (Y = w).length)
              )
                return G + Y + K;
              if (((Y = b.join(",") + "{" + Y + "}"), 0 != T * P)) {
    ...
    t.a = function (e, t) {
      ...
      var x = function () {
        var e = C.apply(this, arguments),
          t = s + "-" + g;
        return (
          void 0 === u.registered[t] && (u.registered[t] = _), k("." + t, e), t
        );
      };
      function E(e, t) {
        var n = "";
  ...
  function (e, t, n) {
            ...
            if (
              ...
              if ((null == v && (v = h), null != n.l)) (h = n.l), (n.l = null);
                ...
                e: if (null == s || s.parentNode !== e) e.appendChild(h);
                  ...
                  for (b = s, l = 0; (b = b.nextSibling) && l < A; l += 2)
                    if (b == h) break e;
                  e.insertBefore(h, s);
                }
    ...
    function be(e) {
      ...
      return (
        t.l &&
          t.l !== n &&
          (t.s.parentNode && t.l.removeChild(t.s), j(t.v), (t.p = !1)),
        e.vnode
          ? t.p
    ...
    var Ct = function (e) {
      ...
      return !(
        n < 0 ||
        (n == t.length - 1 ? t.pop() : wt.call(t, n, 1), --this.size, 0)
      );
    };
    var kt = function (e) {
      var t = this.__data__,
    ...
    var Jr = function (e, t, n, r, a, o) {
      ...
      if (p && !l)
        return (
          o || (o = new En()),
          i || yr(e) ? Mn(e, t, n, r, a, o) : tr(e, t, c, n, r, a, o)
        );
      if (!(n & Gr)) {
    ...
    var qa = function (e, t, n) {
      return (
        ...
        function () {
          for (
            var r = arguments, a = -1, o = Wa(r.length - t, 0), i = Array(o);
            ++a < o;
          ...
          switch (i.label) {
            case 0:
              return [
                4,
                Ge()(
                  "https://cdn.segment.com/v1/projects/" + e + "/integrations"
                ),
              ];
            case 1:
              if (!(t = i.sent()).ok)
              ...
              return [4, t.json()];
            case 2:
              for (n = i.sent(), r = 0, a = n; r < a.length; r++)
                ((o = a[r]).id = o.creationName), delete o.creationName;
              return [2, n];
          }
        });
      });
    ...
    function co(e) {
      ...
      if (r) {
        ...
        if (u.analytics && u.analytics.initialized)
          ...
          u.analytics.addSourceMiddleware(b),
            u.analytics.load(t, { integrations: l });
        }
      } else {
        if (a) return;
          ...
          return (
                  ...
                  switch (C.label) {
                    ...
                    case 1:
                      return (
                        ...
                        (b = h[1]),
                        (v = bo(b, p || {})),
                        (g = p && Object.keys(p).length > 0 && v.length > 0),
                        c
                          ? ((_ = d || s || {}),
            ...
            (n.handleSaveConsent = function (e, t) {
              ...
              n.setState(function (r) {
                ...
                if (i) {
                  var h = i(l, d);
                  (c = h.destinationPreferences),
                    (u = h.customPreferences) ? (d = u) : (u = d);
                } else c = d;
                var m = bo(l, c);
                return (
    ...
    var Vi = function (e) {
        ...
        Se.useEffect(function () {
          return (
            ...
            function () {
              Wi.removeListener("openDialog", g),
        ...
        return Se.createElement(
          ...
          n &&
            Se.createElement(Ui, {
              ...
              onCancel: function () {
                r(!1),
                  e.newDestinations.length > 0 ? u(!0) : e.resetPreferences();
              },
              onSave: function () {
                r(!1), e.saveConsent();
              },
              ...
              function (n) {
                ...
                return Se.createElement(Vi, {
                  ...
                  bannerBackgroundColor:
                    f || t.defaultProps.bannerBackgroundColor,
    ...
    if (
      ...
      "function" != typeof as.consentManagerConfig
    )
